...
const translations = {
    vi: {
        ...
        'faq.q1': 'BUCHAOH là gì?',
        'faq.a1': 'BUCHAOH là sản phẩm nước trái cây lên men từ men vi sinh, được tạo ra thông qua quá trình lên men sinh học có kiểm soát. Sản phẩm sử dụng trái cây làm nguyên liệu chính và hệ vi sinh vật có lợi để tạo thành sản phẩm mang đặc tính chức năng rõ rệt.',
        'faq.q2': 'Sản phẩm có an toàn cho sức khỏe không?',
        'faq.a2': 'Hoàn toàn an toàn. BUCHAOH được sản xuất theo quy trình lên men sinh học kiểm soát chặt chẽ, sử dụng men vi sinh có lợi và nguyên liệu trái cây tự nhiên. Sản phẩm không chứa chất bảo quản, màu tổng hợp hay hương liệu nhân tạo.',
        'faq.q3': 'Cách sử dụng BUCHAOH như thế nào?',
        ...
        'faq.a6': 'Có, tất cả sản phẩm BUCHAOH đều được kiểm định chất lượng tại các phòng lab uy tín, đảm bảo tiêu chuẩn an toàn thực phẩm và có giấy chứng nhận từ Bộ Y tế.',
    ...
    en: {
        ...
        'about.heroTitle': 'What is Buchaoh',
        ...
        'faq.q1': 'What is BUCHAOH?',
        'faq.a1': 'BUCHAOH is a fermented fruit drink made from probiotics, created through a controlled biological fermentation process. The product uses fruits as the main ingredient and beneficial microorganisms to create a product with distinct functional properties.',
        'faq.q2': 'Is the product safe for health?',
        'faq.a2': 'Completely safe. BUCHAOH is produced through a strictly controlled biological fermentation process, using beneficial probiotics and natural fruit ingredients. The product contains no preservatives, synthetic colors, or artificial flavors.',
        'faq.q3': 'How to use BUCHAOH?',
        ...
        'faq.a6': 'Yes, all BUCHAOH products are quality tested in reputable laboratories, ensuring food safety standards and certified by the Ministry of Health.',
