...
export const BlogSection = () => {
    ...
    const blogPosts: BlogPost[] = [
        ...
        {
            id: 2,
            title: 'Hướng dẫn sử dụng BUCHAOH',
            excerpt: 'Cách sử dụng sản phẩm BUCHAOH hiệu quả nhất cho vườn cây của bạn...',
            date: '10/01/2026',
        },
        {
            id: 3,
        ...
        {
            id: 6,
            title: 'Thành công với BUCHAOH',
            excerpt: 'Câu chuyện thành công của nông dân khi sử dụng sản phẩm BUCHAOH...',
            date: '15/12/2025',
        },
    ];
