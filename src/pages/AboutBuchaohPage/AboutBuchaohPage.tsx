  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.comparisonSection}>
        <div className={`${styles.sectionContent} ${styles.animate}`}>
          <h2 className={styles.sectionTitle}>
            {isVi ? 'Sự khác biệt giữa Buchaoh và Kombucha' : 'Difference between Buchaoh and Kombucha'}
          </h2>
          ...
          <div className={styles.comparisonConclusion}>
            <p className={styles.paragraph}>
              {isVi
                ? 'Hai sản phẩm đều dựa trên nguyên lý lên men tự nhiên nhưng được phát triển theo những mục đích sử dụng và quy trình sản xuất khác nhau. Buchaoh tập trung vào mô hình tuần hoàn không rác thải với hai sản phẩm đầu ra phục vụ cả con người và nông nghiệp.'
                : 'Both products are based on natural fermentation principles but developed for different purposes and production processes. Buchaoh focuses on a zero-waste circular model with two outputs serving both people and agriculture.'}
            </p>
          </div>
        </div>
      </section>
