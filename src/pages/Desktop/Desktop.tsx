...
export const Desktop = (): JSX.Element => {
    return (
        <div className="desktop">
            ...
            <div className="div">VỀ BUCHAOH</div>

            <div className="text-wrapper-2">BLOG</div>

            <p className="p">SẢN PHẨM MỚI CỦA BUCHAOH</p>

            <div className="text-wrapper-3">BLOG VỀ BUCHAOH</div>

            <div className="text-wrapper-4">LIÊN HỆ</div>

            <p className="text-wrapper-5">
                BUCHAOH là thương hiệu cung cấp nước và phân bón sinh học từ quá trình
